...
def main(argv):
    ...
    try:
        ...
        outputFileName = "data/stream_aapl.json"
        ...
        def receiveBuffer(tweets):
            for t in tweets:
                ...
                strtweet = '{"created_at":"' + t.date.strftime("%a %b %d %H:%M:%S +0000 %Y") + '","id":' + t.id + ',"text":\"' + t.text.replace("\"","\\\"") +'\"}\n'
                with open(outputFileName, 'a') as f:
                    f.write(strtweet.encode('ascii', 'ignore'))
            #outputFile.flush();
